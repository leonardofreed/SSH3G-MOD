...
fun_botOnOff() {
    [[ $(ps x | grep "bot_plus" | grep -v grep | wc -l) = '0' ]] && {
        clear
        echo -e "\E[44;1;37m             INSTALADOR BOT SSH3G                \E[0m\n"
        ...
        clear
        echo -e "\033[1;32mPARANDO BOT SSH3G... \033[0m\n"
        fun_bot2() {
        ...
        fun_bar 'fun_bot2'
        echo -e "\n\033[1;32m \033[1;31mBOT SSH3G PARADO! \033[0m"
        sleep 2
        menu
    }
}
...
fun_instbot() {
    ...
    echo -e "\n\033[1;32m3° \033[1;37m- \033[1;33mBOT \033[1;37m@SSH3G_BOT \033[1;33mE PEGUE SEU ID DIGITANDO /info \033[1;31mOPCAO: \033[1;37m/id\033[0m"
